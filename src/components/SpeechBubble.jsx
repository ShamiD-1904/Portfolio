      ...
      <div className="robot-bubble relative -top-20 left-76">
        ...
        <div className="relative rounded-2xl px-8 py-4 backdrop-blur-md border-2 border-cyan-50/30"
          ...
          <div className="relative z-10">
            <div className="font-bold bg-gradient-to-r from-cyan-50 via-blue-50 to-purple-50 bg-clip-text text-transparent mb-1" 
                 style={{ 
        ...
        {/* Futuristic tail pointing to robot */}
        <div className="absolute top-full flex flex-col items-center" style={{ left: tailPosition }}>
